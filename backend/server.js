...
app.use(helmet({
    contentSecurityPolicy: {
        directives: {
            ...
            connectSrc:  ["'self'", "ws://localhost:3000", "wss://localhost:3000", "wss://bloodsync.site","wss://bloodsync-production.up.railway.app" , "https://cdn.socket.io", "https://nominatim.openstreetmap.org", "https://psgc.gitlab.io", "https://unpkg.com"],
